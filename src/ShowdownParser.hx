...
class ShowdownParser {
    public static function parse(fileContent:String):Array<PokemonTeam> {
        var json:Array<PokemonTeam> = [];

        var file:Array<String> = fileContent.split("\n");
        ...
        for (line in file) {
            ...
            if (line == "") {
                ...
                if (emptcount == 1) {
                    ...
                    json.push({format: teamFormat, name: teamName, pokemon: teamMons});
    ...
    static function parseStats(str:String, defaultValue:Int):PokemonStats {
